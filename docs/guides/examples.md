...
| Example | What it shows |
| --- | --- |
| [`data-flow-basic`](https://github.com/RiveryIO/terraform-provider-data-integration/tree/main/examples/data-flow-basic) | Minimal Jira → Snowflake full-load flow — the required `properties_json` shape, see [Choosing a data flow type](./data-flow-types.md) |
