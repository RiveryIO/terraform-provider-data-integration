---
page_title: "rivery_connection Resource"
description: |-
  A Data Integration connection to a data source or target.
---

# rivery_connection (Resource)
...
terraform import rivery_connection.warehouse <environment_id>/<connection_id>

# bare id (requires provider-level environment_id)
terraform import rivery_connection.warehouse <connection_id>
```
